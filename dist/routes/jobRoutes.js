...
jobRoutes.use(error_1.errorHandler);
// Get job by ID
jobRoutes.get("/job/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Find job by ID
...
// Create a new job
jobRoutes.post("/job/new", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// Update a job by ID
jobRoutes.put("/job/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Update job document
...
// Delete a job by ID
jobRoutes.delete("/job/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Delete job document
